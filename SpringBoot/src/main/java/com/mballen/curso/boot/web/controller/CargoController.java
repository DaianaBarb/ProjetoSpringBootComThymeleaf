...
public String cadastrar(Cargo cargo) {
	...
	@PostMapping("/salvar")
	public String salvar(Cargo cargo, RedirectAttributes att) {
	...
	@PostMapping("/editar")
	public String editar(Cargo cargo, RedirectAttributes att) {
 ...
 public String excluir(@PathVariable("id") Long id, RedirectAttributes att) {	
	if(service.cargoTemFuncionarios(id)) {
		...
		service.excluir(id);
	att.addFlashAttribute("success","Cargo Excluido com suceso");
